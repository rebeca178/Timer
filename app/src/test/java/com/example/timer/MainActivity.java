...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main); // conecta o XML
        ...
        startButton.setOnClickListener(v -> {
            ...
            currentTime = 0;
            timerText.setText("0");
            handler.removeCallbacks(timerRunnable); // para timers antigos
            handler.postDelayed(timerRunnable, 1000); // começa o novo
        });
    }
